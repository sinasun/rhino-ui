<p align="center">
  <a href="https://rhinolabs.agency" rel="noopener" target="_blank"><img width="150" src="https://rhinolabs.agency/images/palmetto-logo.svg" alt="Palmetto logo"></a></p>
</p>
...
1. Report a bug or propose changes or features by filing an [issue](https://github.com/rthinolabs/rhinolabs-ui/issues).
...
Our component library is based on the [Palmetto Design Tokens](https://github.com/rthinolabs/rhinolabs-ui) design system.
...
If there are additional attributes that you feel should be included in Palmetto Design Tokens, [raise an issue here](https://github.com/rthinolabs/rhinolabs-ui/issues).
