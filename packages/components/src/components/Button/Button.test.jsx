...
describe('Button', () => {
  describe('html button type', () => {
    ...
    test('is not set if "as" prop is an anchor tag', () => {
      render(
        <Button as="a" href="https://www.rhinolabs.agency">
          link button
        </Button>,
      );
  ...
  describe('States', () => {
    ...
    describe('Anchor', () => {
      test('it renders an anchor tag if as prop `a` is passed', () => {
        render(
          <Button href="http://rhinolabs.agency" as="a">
            hey there
          </Button>,
        );
      ...
      test('it renders a target attribute if one is passed, the element is an anchor, and there is a href', () => {
        render(
          <Button href="http://rhinolabs.agency" as="a" target="_blank">
            hey there
          </Button>,
        );
        const buttonElement = screen.getByRole('link');
      ...
      test('it does not render a target attribute if the element is not an anchor', () => {
        render(
          <Button href="http://rhinolabs.agency" target="_blank">
            hey there
          </Button>,
        );
        const buttonElement = screen.getByRole('button');
