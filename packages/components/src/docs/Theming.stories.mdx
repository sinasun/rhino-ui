...
import { color } from '@rhinolabs/design-tokens/build/js/variables-color';
...
The Rhinolabs Design System uses design tokens at its core. Since all design tokens are tied to CSS variables, the underlying values can be overwritten to create a custom theme.
