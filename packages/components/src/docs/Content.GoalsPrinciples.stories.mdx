  ...
  <Box childGap={{ base: 'lg', tablet: 'xl'}}>
    <Box width="100" childGap={{ base: 'md', tablet: '2xl'}} direction={{ base: 'column', tablet: 'row'}}>
      <Box width={{ base: '100', tablet: '33' }} childGap="sm">
        ...
        <Box as="ul"padding="0 0 0 lg" fontSize="sm">
          <li>Help people understand clean energy by using language that informs them and encourages them to make the most of Rhinolabs’s products and services.</li>
        </Box>
      </Box>
      <Box width={{ base: '100', tablet: '33' }} childGap="sm">
    ...
    <Box width="100" childGap={{ base: 'md', tablet: '2xl'}} direction={{ base: 'column', tablet: 'row'}}>
      ...
      <Box width={{ base: '100', tablet: '33' }} childGap="sm">
        ...
        <Box as="ul"padding="0 0 0 lg" fontSize="sm">
          <li>Understand Rhinolabs's place in our users’ lives. Avoid dramatic storytelling and grandiose claims. Focus on our real strengths.</li>
        </Box>
      </Box>
    </Box>
  </Box>
